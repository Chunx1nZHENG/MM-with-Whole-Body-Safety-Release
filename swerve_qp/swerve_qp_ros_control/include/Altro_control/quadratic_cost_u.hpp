...
class QuadraticCostU : public problem::CostFunction {
 public:
  QuadraticCostU(const MatrixXd& Q, const MatrixXd& R, const MatrixXd& H, const VectorXd& q,
  ...
  static QuadraticCostU LQRCost(const MatrixXd& Q, const MatrixXd& R, const VectorXd& xref,
    ...
    VectorXd q = -(Q * xref);
    VectorXd r = -(R * uref);
    double c = 0.5 * uref.dot(R * uref);
    return QuadraticCostU(Q, R, H, q, r, c, terminal);
  }
